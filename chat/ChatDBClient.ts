...
class ChatClient extends WSClient.Client {
  ...
  public sendPrivateMessage(to, message) {
    // サーバにプライベートメッセージを送信する
